...
def protonet_raw_data():
    ...
    train_dataset = goutDataset("/home/xutianxin/Pycharm_code/data_process_pipline/fianl_gout_data_process/train_data/self_supervised_data.csv")
    comorbidities_path = "/home/xutianxin/Pycharm_code/data_process_pipline/fianl_gout_data_process/train_data/"
    single_disease_path = "/home/xutianxin/Pycharm_code/data_process_pipline/fianl_gout_data_process/train_data/"
    ...
    # gout_heart_failure = DataLoader(gout_heart_failure_dataset, batch_size=128,shuffle=True, drop_last=True)
    # gout_myocardial_infaraction = DataLoader(gout_myocardial_infaraction_dataset, batch_size=128,shuffle=True, drop_last=True)
    # gout_hypertension = DataLoader(gout_hypertension_dataset, batch_size=128,shuffle=True, drop_last=True)
    # gout_t2DM = DataLoader(gout_t2DM_dataset, batch_size=128,shuffle=True, drop_last=True)
    # gout_stroke = DataLoader(gout_stroke_dataset, batch_size=128,shuffle=True, drop_last=True)
    # gout_nephrolithiasis = DataLoader(gout_nephrolithiasis_dataset, batch_size=128,shuffle=True, drop_last=True)
    # gout_obesity = DataLoader(gout_obesity_dataset, batch_size=128,shuffle=True)
    # gout_ckd = DataLoader(gout_ckd_dataset, batch_size=128,shuffle=True)
    ...
    heart_failure = DataLoader(heart_failure_dataset, batch_size=128,shuffle=True,drop_last=True)
    myocardial_infaraction = DataLoader(myocardial_infaraction_dataset,batch_size=128,shuffle=True,drop_last=True)
    hypertension = DataLoader(hypertension_dataset,batch_size=128,shuffle=True,drop_last=True)
    t2DM = DataLoader(t2DM_dataset,batch_size=128,shuffle=True, drop_last=True)
    stroke = DataLoader(stroke_dataset,batch_size=128,shuffle=True, drop_last=True)
    nephrolithiasis = DataLoader(nephrolithiasis_dataset,batch_size=128,shuffle=True, drop_last=True)
    obesity = DataLoader(obesity_dataset,batch_size=128,shuffle=True, drop_last=True)
    ckd = DataLoader(ckd_dataset,batch_size=128,shuffle=True, drop_last=True)
    gout = DataLoader(gout_dataset,batch_size=128,shuffle=True, drop_last=True)
